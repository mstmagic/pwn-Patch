...
if ($Config.Config.Notification.User.MessageBody -eq $null) { $Config.SelectNodes("Config/Notification/User").SetAttribute( "MessageBody",@"
...
"@) }
if ($Config.Config.Notification.Admin.MessageBody -eq $null) { $Config.SelectNodes("Config/Notification/Admin").SetAttribute( "MessageBody",@"
...
$main.controls.AddRange(@($l_ScriptFile,$t_ScriptFile,$l_ScriptFile_NotFound,$l_SettingsFile,$t_SettingsFile,$l_SettingsFile_NotFound,$l_DSInternals,$l_DSInternals_Status,$b_DSInternals_Install,$l_SearchBase,$t_SearchBase,$l_Dictionary,$t_Dictionary,$l_Dictionary_Missing,$b_Dictionary_Browse,$l_Index,$t_Index,$l_Index_Missing,$b_Index_Browse,$b_Index_ReIndex,$l_MailAddress,$t_MailAddress,$l_MailPort,$t_MailPort,$c_MailSSL,$g_Notification,$b_SaveConfig))
...
$l_DSInternals.Top = $l_SettingsFile.Bottom + 5
...
$b_DSInternals_Install.Left = $l_DSInternals.Right + 5
$l_DSInternals_Status.Top = $l_DSInternals.Top + (($l_DSInternals.Height - $l_DSInternals_Status.Height) / 2) 
$l_DSInternals_Status.Left = $b_DSInternals_Install.Right + 5
...
$l_SearchBase.Top = $l_Index.Bottom + 5
$l_SearchBase.Left = $l_Index.Left
